...
TEST_CASE("Good snowman code") {
	...
	CHECK(nospaces(snowman(34444441)) == nospaces("_===_\n(-,-)\n( : )\n( : )"));
	CHECK(nospaces(snowman(34444442)) == nospaces("_===_\n(-,-)\n( : )\n( : )"));
	CHECK(nospaces(snowman(34444443)) == nospaces("_===_\n(-,-)\n( : )\n( : )"));
	CHECK(nospaces(snowman(43214321)) == nospaces("_===_\n(o,.)\n( : )\n( : )"));
